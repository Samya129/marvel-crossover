...
function generateHeroReveal() {
  ...
  var revealElemContents = $("<div>").attr("id", "reveal-elem-contents");
...
function clickCardInfo(heroName) {
  ...
  var modalPic = $("<img>").attr("id", "modalHeroImage");
  heroInfo.append(modalPic);

  // create a place to put the Images
  var heroParagraphs = $("<div>").attr("id", "hero-paragraphs");
  heroInfo.append(heroParagraphs);
  var heroPosterDiv = $("<div>").attr("id", "hero-poster-div");
